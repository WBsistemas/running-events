    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md mx-auto animate-pulse">
        <CardHeader>
          ...
          <CardTitle className="h-7 bg-gray-200 rounded w-1/2 mx-auto"></CardTitle>
          <CardDescription className="h-4 bg-gray-200 rounded w-3/4 mx-auto mt-2"></CardDescription>
        </CardHeader>
